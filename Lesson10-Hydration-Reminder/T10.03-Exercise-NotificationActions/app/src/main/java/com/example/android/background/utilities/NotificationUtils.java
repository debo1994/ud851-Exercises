...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 420;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 422;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context, WATER_REMINDER_NOTIFICATION_CHANNEL_ID)
                ...
                .addAction(ignoreRemainderActions(context))
    ...
    private static NotificationCompat.Action ignoreRemainderActions(Context context) {
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        NotificationCompat.Action drinkWaterAction = new NotificationCompat.Action(
                R.drawable.ic_local_drink_black_24px, "I did it!", ignoreReminderPendingIntent);
